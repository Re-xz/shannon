...
BOT_TOKEN = getenv("BOT_TOKEN", "6601730988:AAF5pAmyyu7OnymSD_HFoDlMt8Ko_AiChKo")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002032868386"))
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6396921435").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Re-xz/shannon",
)
